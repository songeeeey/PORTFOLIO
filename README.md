...
- 처리 속도 249초 → 167초 (33% 단축)

**기술 스택:** `Python` `LangChain` `MySQL` `HuggingFace`
...
- 최종 모델 정확도 0.762, 이탈 클래스 재현율 0.73 달성
...
## 📚 Education
- 국민대학교 정보보안암호수학과 (부전공: 소프트웨어미디어융합전공) 졸업
- SK 네트웍스 Family AI캠프 17기 수료 (2025.06 ~ 2025.12)
